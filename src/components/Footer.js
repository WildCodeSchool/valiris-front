      ...
      <nav className='nav-footer'>
        ...
        <div className='icons-container'>
          ...
          <ul className='menu-footer-icons'>
            <li><a href='https://www.facebook.com/' rel="noopener noreferrer" className='facebook-icon' target='_blank'><FacebookIcon fontSize='large' /></a></li>
            <li><a href='https://www.youtube.com/' rel="noopener noreferrer" className='youtube-icon' target='_blank'><YoutubeIcon fontSize='large' /></a></li>
          </ul>
        </div>
